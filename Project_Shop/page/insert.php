<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        try {
            ...
            $path = "../images/product-images/" . $image_file; // set upload folder path
            ...
            if (empty($name)) {
                ...
                if (!file_exists($path)) { // check file not exist in your upload folder path
                    if ($size < 5000000) { // check file size 5MB
                        move_uploaded_file($temp, '../images/product-images/'.$image_file); // move upload file temperory directory to your upload folder
                    } else {
            ...
            if (!isset($errorMsg)) {
                $sql = "INSERT INTO tblproduct (`id`, `name`, `code`, `image`, `price`, `type_id`) VALUES (:fid, :fname, :fcode, :fimage, :fprice, :ftype_id)";
                ...
                $insert_stmt->bindParam(':ftype_id', $type_id);
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            <div class="row">
            <label for="name" class="col-sm-3 control-label">Type_id</label>
            <div class="col-sm-9">
                <input type="text" name="type_id" class="form-control" placeholder="Enter type_id">
            </div>
            </div>
        </div>
